...
/* harmony import */ var _global_untilDestroy__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @global/untilDestroy */ "../global/untilDestroy/index.ts");
/* harmony import */ var _app_core_services_jsonld_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @app/core/services/jsonld.service */ "./src/app/core/services/jsonld.service.ts");
...
/* harmony import */ var _app_reducers__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @app/reducers */ "./src/app/reducers/index.ts");
...
let ProductDetailComponent = class ProductDetailComponent {
    ...
    getProduct() {
        this.product$ = this.route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])((params) => {
    ...
    formSetup(height, weight) {
        if (this.product.club_kit) {
            ...
            if (this.product.attributes) {
                ...
                this.addToCartForm
                    .get('attributes')
                    .valueChanges.pipe(Object(_global_untilDestroy__WEBPACK_IMPORTED_MODULE_9__["untilComponentDestroyed"])(this))
                    .subscribe((resp) => {
    ...
    addValidators(add) {
        ...
        this.addToCartForm
            .get('normal_custom')
            .get('name_colour')
            .setValidators(!add ? null : [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]);
        this.addToCartForm
            .get('normal_custom')
            .get('name_colour')
    ...
    addKitVariation(variation, attribute) {
        ...
        const attributeControl = this.addToCartForm
            .get('attributes')['controls'].find((c) => c.get('_id').value === attribute._id);
    ...
    clubKitQtyCheck() {
        const controls = this.addToCartForm.controls['attributes']
            .controls;
        const qty = controls
            .map((c) => {
    ...
    changeImage(variation) {
        ...
        this.selectedVariation.attribute_terms.forEach((term, index) => {
            this.addToCartForm
                .get('attributes')['controls'][index].get('term')
...
ProductDetailComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ngrx_store__WEBPACK_IMPORTED_MODULE_11__["Store"],
        ...
        _app_core_services_jsonld_service__WEBPACK_IMPORTED_MODULE_10__["JsonldService"]])
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../../node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "../../node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _app_core_services_data_layer_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @app/core/services/data-layer.service */ "./src/app/core/services/data-layer.service.ts");
...
], ProductItemComponent.prototype, "position", void 0);
ProductItemComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_app_core_services_data_layer_service__WEBPACK_IMPORTED_MODULE_2__["DataLayerService"]])
...
/* harmony import */ var _app_shared_modules_sidebar_nav_sidebar_nav_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @app/shared/modules/sidebar-nav/sidebar-nav.module */ "./src/app/shared/modules/sidebar-nav/sidebar-nav.module.ts");
...
/* harmony import */ var _product_list_product_item_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./product-list/product-item.component */ "./src/app/products/product-list/product-item.component.ts");
/* harmony import */ var _product_list_product_list_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./product-list/product-list.component */ "./src/app/products/product-list/product-list.component.ts");
/* harmony import */ var _products_routing_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./products-routing.module */ "./src/app/products/products-routing.module.ts");
...
ProductsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _app_shared_modules_card_card_module__WEBPACK_IMPORTED_MODULE_4__["CardModule"],
            ...
            _app_shared_modules_sidebar_nav_sidebar_nav_module__WEBPACK_IMPORTED_MODULE_5__["SidebarNavModule"]
        ],
        declarations: [
            ...
            _product_list_product_item_component__WEBPACK_IMPORTED_MODULE_8__["ProductItemComponent"]
        ],
        providers: []
    })
], ProductsModule);
...
//# sourceMappingURL=app-products-products-module-es2015.js.map