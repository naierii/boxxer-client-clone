    ...
    "./src/app/core/services/jsonld.service.ts": function srcAppCoreServicesJsonldServiceTs(module, __webpack_exports__, __webpack_require__) {
        ...
        var JsonldService = function() {
            function JsonldService() {
                ...
                this.logo = "".concat(_env_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].site, "/boxxer-client-clone/assets/img/facebook-logo.jpg");
            ...
            _createClass(JsonldService, [ {
                ...
                value: function product(data) {
                    ...
                    if (data.image) {
                        ...
                        image = "".concat(_env_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].site, "/boxxer-client-clone/assets/img/facebook-logo.jpg");
                    }
                    this.schema = {
                        "@context": "http://schema.org",
                        "@type": "Product",
