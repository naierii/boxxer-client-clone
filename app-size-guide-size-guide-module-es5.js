...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-size-guide-size-guide-module"], {
  /***/
  "../../node_modules/raw-loader/dist/cjs.js!./src/app/size-guide/custom-sizes/custom-sizes-item.component.html": function node_modulesRawLoaderDistCjsJsSrcAppSizeGuideCustomSizesCustomSizesItemComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "../../node_modules/raw-loader/dist/cjs.js!./src/app/size-guide/custom-sizes/custom-sizes.component.html": function node_modulesRawLoaderDistCjsJsSrcAppSizeGuideCustomSizesCustomSizesComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/size-guide/custom-sizes/custom-sizes-item.component.scss": function srcAppSizeGuideCustomSizesCustomSizesItemComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/size-guide/custom-sizes/custom-sizes-item.component.ts": function srcAppSizeGuideCustomSizesCustomSizesItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CustomSizesItemComponent", function () {
      return CustomSizesItemComponent;
    });
    /* harmony import */
    ...
    var CustomSizesItemComponent = function CustomSizesItemComponent() {
      _classCallCheck(this, CustomSizesItemComponent);
    };

    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)], CustomSizesItemComponent.prototype, "item", void 0);
    CustomSizesItemComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'bx-custom-sizes-item, [bx-custom-sizes-item]',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./custom-sizes-item.component.html */
      "../../node_modules/raw-loader/dist/cjs.js!./src/app/size-guide/custom-sizes/custom-sizes-item.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./custom-sizes-item.component.scss */
      "./src/app/size-guide/custom-sizes/custom-sizes-item.component.scss"))["default"]]
    })], CustomSizesItemComponent);
    /***/
  },

  /***/
  "./src/app/size-guide/custom-sizes/custom-sizes.component.scss": function srcAppSizeGuideCustomSizesCustomSizesComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/size-guide/custom-sizes/custom-sizes.component.ts": function srcAppSizeGuideCustomSizesCustomSizesComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CustomSizesComponent", function () {
      return CustomSizesComponent;
    });
    /* harmony import */
    ...
    var CustomSizesComponent = /*#__PURE__*/function () {
      function CustomSizesComponent(api) {
        _classCallCheck(this, CustomSizesComponent);

        this.api = api;
        this.page$ = api.get('page', 'size-guide');
        this.terms$ = api.find('term', {
      ...
      _createClass(CustomSizesComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "getSizes",
        value: function getSizes(category) {
          var _this = this;
          ...
          this.sizes$ = this.api.find('size', Object.assign({}, query, {
            $limit: 48,
            $sort: {
              weight: 1
            }
            ...
            if (!size) {
              _this.sizes = resp.map(function (s) {
                return s.size;
        ...
        key: "filterByType",
        value: function filterByType(id) {
        ...
        key: "filterBySize",
        value: function filterBySize(size) {
    ...
    CustomSizesComponent.ctorParameters = function () {
      return [{
        type: _app_core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"]
      }];
    };

    CustomSizesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'bx-custom-sizes',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./custom-sizes.component.html */
      "../../node_modules/raw-loader/dist/cjs.js!./src/app/size-guide/custom-sizes/custom-sizes.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./custom-sizes.component.scss */
      "./src/app/size-guide/custom-sizes/custom-sizes.component.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_app_core_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"]])], CustomSizesComponent);
    /***/
  },

  /***/
  "./src/app/size-guide/size-guide-routing.module.ts": function srcAppSizeGuideSizeGuideRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SizeGuideRoutingModule", function () {
      return SizeGuideRoutingModule;
    });
    /* harmony import */
    ...
    var _custom_sizes_custom_sizes_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./custom-sizes/custom-sizes.component */
    ...
    var SizeGuideRoutingModule = function SizeGuideRoutingModule() {
      _classCallCheck(this, SizeGuideRoutingModule);
    };

    SizeGuideRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
  ...
  /***/
  "./src/app/size-guide/size-guide.module.ts": function srcAppSizeGuideSizeGuideModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SizeGuideModule", function () {
      return SizeGuideModule;
    });
    /* harmony import */
    ...
    var _size_guide_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./size-guide-routing.module */
    "./src/app/size-guide/size-guide-routing.module.ts");
    /* harmony import */


    var _custom_sizes_custom_sizes_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./custom-sizes/custom-sizes.component */
    "./src/app/size-guide/custom-sizes/custom-sizes.component.ts");
    /* harmony import */


    var _custom_sizes_custom_sizes_item_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./custom-sizes/custom-sizes-item.component */
    "./src/app/size-guide/custom-sizes/custom-sizes-item.component.ts");
    /* harmony import */


    var _app_shared_modules_card_card_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! @app/shared/modules/card/card.module */
    "./src/app/shared/modules/card/card.module.ts");
    /* harmony import */


    var _app_material_material_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    var SizeGuideModule = function SizeGuideModule() {
      _classCallCheck(this, SizeGuideModule);
    };

    SizeGuideModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      imports: [_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_1__["SharedModule"], _size_guide_routing_module__WEBPACK_IMPORTED_MODULE_3__["SizeGuideRoutingModule"], _app_shared_modules_card_card_module__WEBPACK_IMPORTED_MODULE_6__["CardModule"], _app_material_material_module__WEBPACK_IMPORTED_MODULE_7__["MaterialModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["ReactiveFormsModule"]],
...
//# sourceMappingURL=app-size-guide-size-guide-module-es5.js.map